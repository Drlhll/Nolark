...
-- -------------------------------------------------------------
GRANT USAGE ON * . * TO  'nolarkuser'@'%' IDENTIFIED BY 'nolarkpwd' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

-- ----------------------------------------------------------------------------------------
-- Donner tous les privilèges (hors ceux d'administration) à nolarkuser sur la BDD nolark -
-- ----------------------------------------------------------------------------------------
GRANT SELECT ON `nolark`.* TO 'nolarkuser'@'%';
